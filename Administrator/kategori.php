...
<form name="form" action="deletemultiplekategori.php" method="post" onsubmit="return deleteConfirm();"/>
...
<?php 
  ...
  include "koneksi.php";
  $no = 0;
  $modal=mysqli_query($koneksi, "SELECT * FROM kategori") or die("Error: " . mysqli_error($koneksi));
  while($r=mysqli_fetch_array($modal)){
  $no++;
       
?>
  <tr>
  	  <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $r['id_kategori'];?>"/></td>
      <td><?php echo $no; ?></td>
      <td><?php echo  $r['id_kategori']; ?></td>
      <td><?php echo  $r['nama_kategori']; ?></a></td>
  
      <td>
         <a href="#" class='open_modal btn btn-primary' id='<?php echo  $r['id_kategori']; ?>'>Edit <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
         <a href="#" onclick="confirm_modal('proses_delete_kategori.php?&id_kategori=<?php echo  $r['id_kategori']; ?>');" class="btn btn-danger">Delete<i class="fa fa-trash" aria-hidden="true"></i></a>
